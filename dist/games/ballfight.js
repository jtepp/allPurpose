(function () {
    ...
    Embed.prototype = {
        url: "https://www.khanacademy.org/computer-programming/ball-fight-culminating-game/6286638934687744/embedded?editor=no&buttons=no&author=no&embed=yes",
        ...
        getIframe: function () {
            ...
            var toolbarHeight = 0; // Wonder-blocks toolbar (w/borders)
            var editorWidth = 540;
            var canvasWidth = 600;
            var defaultHeight = 400;
            var borderWidth = 0;
            var borderHeight = 1; // Top border thickness
